...
(declare-fun main_~k~1_51 () Int)
(declare-fun main_~i~1_51 () Int)
(declare-fun main_~j~1_54 () Int)
(declare-fun main_~k~1_54 () Int)
(declare-fun main_~i~1_54 () Int)
(declare-fun main_~j~1_57 () Int)
(declare-fun main_~k~1_57 () Int)
(declare-fun main_~i~1_57 () Int)
(declare-fun main_~j~1_60 () Int)
(declare-fun main_~k~1_60 () Int)
(declare-fun main_~i~1_60 () Int)
(declare-fun main_~j~1_63 () Int)
(declare-fun main_~k~1_63 () Int)
...
(assert (! (<= (mod main_~k~1_48 4294967296) (mod (* 3 main_~i~1_48) 4294967296)) :named ssa_49_conjunct0))
(assert (! (>= (mod main_~k~1_48 4294967296) (mod (* 3 main_~i~1_48) 4294967296)) :named ssa_49_conjunct1))
(assert (! (<= (mod (* 2 main_~i~1_48) 4294967296) (mod main_~j~1_48 4294967296)) :named ssa_49_conjunct2))
(assert (! (>= (mod (* 2 main_~i~1_48) 4294967296) (mod main_~j~1_48 4294967296)) :named ssa_49_conjunct3))
(assert (! true :named ssa_50_conjunct0))
(assert (! (< (mod main_~k~1_48 4294967296) 60) :named ssa_51_conjunct0))
(assert (! (<= main_~k~1_51 (+ main_~k~1_48 3)) :named ssa_51_conjunct1))
(assert (! (>= main_~k~1_51 (+ main_~k~1_48 3)) :named ssa_51_conjunct2))
(assert (! (<= main_~j~1_51 (+ main_~j~1_48 2)) :named ssa_51_conjunct3))
(assert (! (>= main_~j~1_51 (+ main_~j~1_48 2)) :named ssa_51_conjunct4))
(assert (! (<= main_~i~1_51 (+ main_~i~1_48 1)) :named ssa_51_conjunct5))
(assert (! (>= main_~i~1_51 (+ main_~i~1_48 1)) :named ssa_51_conjunct6))
(assert (! (<= (mod main_~k~1_51 4294967296) (mod (* 3 main_~i~1_51) 4294967296)) :named ssa_52_conjunct0))
(assert (! (>= (mod main_~k~1_51 4294967296) (mod (* 3 main_~i~1_51) 4294967296)) :named ssa_52_conjunct1))
(assert (! (<= (mod (* 2 main_~i~1_51) 4294967296) (mod main_~j~1_51 4294967296)) :named ssa_52_conjunct2))
(assert (! (>= (mod (* 2 main_~i~1_51) 4294967296) (mod main_~j~1_51 4294967296)) :named ssa_52_conjunct3))
(assert (! true :named ssa_53_conjunct0))
(assert (! (< (mod main_~k~1_51 4294967296) 60) :named ssa_54_conjunct0))
(assert (! (<= main_~k~1_54 (+ main_~k~1_51 3)) :named ssa_54_conjunct1))
(assert (! (>= main_~k~1_54 (+ main_~k~1_51 3)) :named ssa_54_conjunct2))
(assert (! (<= main_~j~1_54 (+ main_~j~1_51 2)) :named ssa_54_conjunct3))
(assert (! (>= main_~j~1_54 (+ main_~j~1_51 2)) :named ssa_54_conjunct4))
(assert (! (<= main_~i~1_54 (+ main_~i~1_51 1)) :named ssa_54_conjunct5))
(assert (! (>= main_~i~1_54 (+ main_~i~1_51 1)) :named ssa_54_conjunct6))
(assert (! (<= (mod main_~k~1_54 4294967296) (mod (* 3 main_~i~1_54) 4294967296)) :named ssa_55_conjunct0))
(assert (! (>= (mod main_~k~1_54 4294967296) (mod (* 3 main_~i~1_54) 4294967296)) :named ssa_55_conjunct1))
(assert (! (<= (mod (* 2 main_~i~1_54) 4294967296) (mod main_~j~1_54 4294967296)) :named ssa_55_conjunct2))
(assert (! (>= (mod (* 2 main_~i~1_54) 4294967296) (mod main_~j~1_54 4294967296)) :named ssa_55_conjunct3))
(assert (! true :named ssa_56_conjunct0))
(assert (! (< (mod main_~k~1_54 4294967296) 60) :named ssa_57_conjunct0))
(assert (! (<= main_~k~1_57 (+ main_~k~1_54 3)) :named ssa_57_conjunct1))
(assert (! (>= main_~k~1_57 (+ main_~k~1_54 3)) :named ssa_57_conjunct2))
(assert (! (<= main_~j~1_57 (+ main_~j~1_54 2)) :named ssa_57_conjunct3))
(assert (! (>= main_~j~1_57 (+ main_~j~1_54 2)) :named ssa_57_conjunct4))
(assert (! (<= main_~i~1_57 (+ main_~i~1_54 1)) :named ssa_57_conjunct5))
(assert (! (>= main_~i~1_57 (+ main_~i~1_54 1)) :named ssa_57_conjunct6))
(assert (! (<= (mod main_~k~1_57 4294967296) (mod (* 3 main_~i~1_57) 4294967296)) :named ssa_58_conjunct0))
(assert (! (>= (mod main_~k~1_57 4294967296) (mod (* 3 main_~i~1_57) 4294967296)) :named ssa_58_conjunct1))
(assert (! (<= (mod (* 2 main_~i~1_57) 4294967296) (mod main_~j~1_57 4294967296)) :named ssa_58_conjunct2))
(assert (! (>= (mod (* 2 main_~i~1_57) 4294967296) (mod main_~j~1_57 4294967296)) :named ssa_58_conjunct3))
(assert (! true :named ssa_59_conjunct0))
(assert (! (< (mod main_~k~1_57 4294967296) 60) :named ssa_60_conjunct0))
(assert (! (<= main_~k~1_60 (+ main_~k~1_57 3)) :named ssa_60_conjunct1))
(assert (! (>= main_~k~1_60 (+ main_~k~1_57 3)) :named ssa_60_conjunct2))
(assert (! (<= main_~j~1_60 (+ main_~j~1_57 2)) :named ssa_60_conjunct3))
(assert (! (>= main_~j~1_60 (+ main_~j~1_57 2)) :named ssa_60_conjunct4))
(assert (! (<= main_~i~1_60 (+ main_~i~1_57 1)) :named ssa_60_conjunct5))
(assert (! (>= main_~i~1_60 (+ main_~i~1_57 1)) :named ssa_60_conjunct6))
(assert (! (<= (mod main_~k~1_60 4294967296) (mod (* 3 main_~i~1_60) 4294967296)) :named ssa_61_conjunct0))
(assert (! (>= (mod main_~k~1_60 4294967296) (mod (* 3 main_~i~1_60) 4294967296)) :named ssa_61_conjunct1))
(assert (! (<= (mod (* 2 main_~i~1_60) 4294967296) (mod main_~j~1_60 4294967296)) :named ssa_61_conjunct2))
(assert (! (>= (mod (* 2 main_~i~1_60) 4294967296) (mod main_~j~1_60 4294967296)) :named ssa_61_conjunct3))
(assert (! true :named ssa_62_conjunct0))
(assert (! (< (mod main_~k~1_60 4294967296) 60) :named ssa_63_conjunct0))
(assert (! (<= main_~k~1_63 (+ main_~k~1_60 3)) :named ssa_63_conjunct1))
(assert (! (>= main_~k~1_63 (+ main_~k~1_60 3)) :named ssa_63_conjunct2))
(assert (! (<= main_~j~1_63 (+ main_~j~1_60 2)) :named ssa_63_conjunct3))
(assert (! (>= main_~j~1_63 (+ main_~j~1_60 2)) :named ssa_63_conjunct4))
(assert (! (<= main_~i~1_63 (+ main_~i~1_60 1)) :named ssa_63_conjunct5))
(assert (! (>= main_~i~1_63 (+ main_~i~1_60 1)) :named ssa_63_conjunct6))
(assert (! (or (not (= (mod (* 3 main_~i~1_63) 4294967296) (mod main_~k~1_63 4294967296))) (not (= (mod (* 2 main_~i~1_63) 4294967296) (mod main_~j~1_63 4294967296)))) :named ssa_64_conjunct0))
(check-sat)
(get-unsat-core)
