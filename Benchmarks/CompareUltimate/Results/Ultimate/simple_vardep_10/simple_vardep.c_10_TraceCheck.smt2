...
(assert (! (<= main_~k~1_9 (+ main_~k~1_6 3)) :named ssa_9_conjunct0))
(assert (! (>= main_~k~1_9 (+ main_~k~1_6 3)) :named ssa_9_conjunct1))
(assert (! (< (mod main_~k~1_6 4294967296) 30) :named ssa_9_conjunct2))
...
(assert (! (<= main_~k~1_12 (+ main_~k~1_9 3)) :named ssa_12_conjunct0))
(assert (! (>= main_~k~1_12 (+ main_~k~1_9 3)) :named ssa_12_conjunct1))
(assert (! (< (mod main_~k~1_9 4294967296) 30) :named ssa_12_conjunct2))
...
(assert (! (<= main_~k~1_15 (+ main_~k~1_12 3)) :named ssa_15_conjunct0))
(assert (! (>= main_~k~1_15 (+ main_~k~1_12 3)) :named ssa_15_conjunct1))
(assert (! (< (mod main_~k~1_12 4294967296) 30) :named ssa_15_conjunct2))
...
(assert (! (<= main_~k~1_18 (+ main_~k~1_15 3)) :named ssa_18_conjunct0))
(assert (! (>= main_~k~1_18 (+ main_~k~1_15 3)) :named ssa_18_conjunct1))
(assert (! (< (mod main_~k~1_15 4294967296) 30) :named ssa_18_conjunct2))
...
(assert (! (<= main_~k~1_21 (+ main_~k~1_18 3)) :named ssa_21_conjunct0))
(assert (! (>= main_~k~1_21 (+ main_~k~1_18 3)) :named ssa_21_conjunct1))
(assert (! (< (mod main_~k~1_18 4294967296) 30) :named ssa_21_conjunct2))
...
(assert (! (<= main_~k~1_24 (+ main_~k~1_21 3)) :named ssa_24_conjunct0))
(assert (! (>= main_~k~1_24 (+ main_~k~1_21 3)) :named ssa_24_conjunct1))
(assert (! (< (mod main_~k~1_21 4294967296) 30) :named ssa_24_conjunct2))
...
(assert (! (<= main_~k~1_27 (+ main_~k~1_24 3)) :named ssa_27_conjunct0))
(assert (! (>= main_~k~1_27 (+ main_~k~1_24 3)) :named ssa_27_conjunct1))
(assert (! (< (mod main_~k~1_24 4294967296) 30) :named ssa_27_conjunct2))
...
(assert (! (<= main_~k~1_30 (+ main_~k~1_27 3)) :named ssa_30_conjunct0))
(assert (! (>= main_~k~1_30 (+ main_~k~1_27 3)) :named ssa_30_conjunct1))
(assert (! (< (mod main_~k~1_27 4294967296) 30) :named ssa_30_conjunct2))
...
(assert (! (<= main_~k~1_33 (+ main_~k~1_30 3)) :named ssa_33_conjunct0))
(assert (! (>= main_~k~1_33 (+ main_~k~1_30 3)) :named ssa_33_conjunct1))
(assert (! (< (mod main_~k~1_30 4294967296) 30) :named ssa_33_conjunct2))
...
(assert (! (or (not (= (mod (* 3 main_~i~1_33) 4294967296) (mod main_~k~1_33 4294967296))) (not (= (mod (* 2 main_~i~1_33) 4294967296) (mod main_~j~1_33 4294967296)))) :named ssa_34_conjunct0))
(check-sat)
(get-unsat-core)
