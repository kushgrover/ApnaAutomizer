...
(assert (! (or (not (= (mod (* 3 main_~i~1_12) 4294967296) (mod main_~k~1_12 4294967296))) (not (= (mod (* 2 main_~i~1_12) 4294967296) (mod main_~j~1_12 4294967296)))) :named ssa_13_conjunct0))
(check-sat)
(get-unsat-core)
