...
(assert (! (<= main_~a~2_21 (+ main_~a~2_12 2)) :named ssa_21_conjunct0))
(assert (! (>= main_~a~2_21 (+ main_~a~2_12 2)) :named ssa_21_conjunct1))
(assert (! (<= |main_#t~ret0_19| 0) :named ssa_21_conjunct2))
(assert (! (>= |main_#t~ret0_19| 0) :named ssa_21_conjunct3))
(assert (! (<= main_~b~2_21 (+ main_~b~2_12 1)) :named ssa_21_conjunct4))
(assert (! (>= main_~b~2_21 (+ main_~b~2_12 1)) :named ssa_21_conjunct5))
