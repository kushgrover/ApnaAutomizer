...
(declare-fun rand_~x~1_53 () Int)
(declare-fun |rand_#res_53| () Int)
(declare-fun |main_#t~ret0_55| () Int)
(declare-fun |main_#t~ret0_57| () Int)
(declare-fun main_~a~2_57 () Int)
(declare-fun main_~b~2_57 () Int)
...
(assert (! (< main_~i~2_49 main_~n~2_4) :named ssa_51_conjunct0))
(assert (! true :named ssa_52_GlobVarAssigCall_conjunct0))
(assert (! true :named ssa_52_LocVarAssigCall_conjunct0))
(assert (! true :named ssa_52_OldVarAssigCall_conjunct0))
(assert (! (<= |rand_#res_53| (ite (and (not (= 0 (mod rand_~x~1_53 2))) (< rand_~x~1_53 0)) (+ (mod rand_~x~1_53 2) (- 2)) (mod rand_~x~1_53 2))) :named ssa_53_conjunct0))
(assert (! (>= |rand_#res_53| (ite (and (not (= 0 (mod rand_~x~1_53 2))) (< rand_~x~1_53 0)) (+ (mod rand_~x~1_53 2) (- 2)) (mod rand_~x~1_53 2))) :named ssa_53_conjunct1))
(assert (! true :named ssa_54_conjunct0))
(assert (! (<= |main_#t~ret0_55| |rand_#res_53|) :named ssa_55_return_conjunct0))
(assert (! (>= |main_#t~ret0_55| |rand_#res_53|) :named ssa_55_return_conjunct1))
(assert (! (<= 0 (+ |main_#t~ret0_55| 2147483648)) :named ssa_56_conjunct0))
(assert (! (<= |main_#t~ret0_55| 2147483647) :named ssa_56_conjunct1))
(assert (! (not (= |main_#t~ret0_55| 0)) :named ssa_57_conjunct0))
(assert (! (<= main_~b~2_57 (+ main_~b~2_48 2)) :named ssa_57_conjunct1))
(assert (! (>= main_~b~2_57 (+ main_~b~2_48 2)) :named ssa_57_conjunct2))
(assert (! (<= main_~a~2_57 (+ main_~a~2_48 1)) :named ssa_57_conjunct3))
(assert (! (>= main_~a~2_57 (+ main_~a~2_48 1)) :named ssa_57_conjunct4))
(assert (! (<= main_~i~2_58 (+ main_~i~2_49 1)) :named ssa_58_conjunct0))
(assert (! (>= main_~i~2_58 (+ main_~i~2_49 1)) :named ssa_58_conjunct1))
(assert (! true :named ssa_59_conjunct0))
(assert (! (not (< main_~i~2_58 main_~n~2_4)) :named ssa_60_conjunct0))
(assert (! (not (= (+ main_~a~2_57 main_~b~2_57) (* 3 main_~n~2_4))) :named ssa_61_conjunct0))
(check-sat)
(get-unsat-core)
