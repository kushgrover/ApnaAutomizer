...
(assert (! (or (not (= (mod (* 3 main_~i~1_54) 4294967296) (mod main_~k~1_54 4294967296))) (not (= (mod (* 2 main_~i~1_54) 4294967296) (mod main_~j~1_54 4294967296)))) :named ssa_55_conjunct0))
(check-sat)
(get-unsat-core)
