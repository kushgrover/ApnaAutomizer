...
(declare-fun |main_#t~post0_12| () Int)
...
(assert (! (not (<= (mod main_~j~1_9 4294967296) 3)) :named ssa_11_conjunct0))
(assert (! (<= main_~i~1_12 (+ main_~i~1_4 1)) :named ssa_12_conjunct0))
(assert (! (>= main_~i~1_12 (+ main_~i~1_4 1)) :named ssa_12_conjunct1))
(assert (! true :named ssa_13_conjunct0))
(assert (! (not (<= (mod main_~i~1_12 4294967296) 3)) :named ssa_14_conjunct0))
(assert (! (not (= (mod main_~k~1_8 4294967296) 36)) :named ssa_15_conjunct0))
(check-sat)
(get-unsat-core)
