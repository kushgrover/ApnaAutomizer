...
(declare-fun |main_#t~post0_9| () Int)
...
(assert (! (not (<= (mod main_~j~1_6 4294967296) 3)) :named ssa_8_conjunct0))
(assert (! (<= main_~i~1_9 (+ main_~i~1_4 1)) :named ssa_9_conjunct0))
(assert (! (>= main_~i~1_9 (+ main_~i~1_4 1)) :named ssa_9_conjunct1))
(assert (! true :named ssa_10_conjunct0))
(assert (! (not (<= (mod main_~i~1_9 4294967296) 3)) :named ssa_11_conjunct0))
(assert (! (not (= (mod main_~k~1_4 4294967296) 36)) :named ssa_12_conjunct0))
(check-sat)
(get-unsat-core)
