...
(declare-fun main_~j~1_46 () Int)
(declare-fun |main_#t~post1_46| () Int)
(declare-fun |main_#t~post0_49| () Int)
...
(assert (! (<= main_~k~1_45 (+ main_~i~1_32 main_~j~1_43 main_~k~1_42)) :named ssa_45_conjunct0))
(assert (! (>= main_~k~1_45 (+ main_~i~1_32 main_~j~1_43 main_~k~1_42)) :named ssa_45_conjunct1))
(assert (! (<= (mod main_~j~1_43 4294967296) 3) :named ssa_45_conjunct2))
(assert (! (<= main_~j~1_46 (+ main_~j~1_43 1)) :named ssa_46_conjunct0))
(assert (! (>= main_~j~1_46 (+ main_~j~1_43 1)) :named ssa_46_conjunct1))
(assert (! true :named ssa_47_conjunct0))
(assert (! (not (<= (mod main_~j~1_46 4294967296) 3)) :named ssa_48_conjunct0))
(assert (! (<= main_~i~1_49 (+ main_~i~1_32 1)) :named ssa_49_conjunct0))
(assert (! (>= main_~i~1_49 (+ main_~i~1_32 1)) :named ssa_49_conjunct1))
(assert (! true :named ssa_50_conjunct0))
(assert (! (not (<= (mod main_~i~1_49 4294967296) 3)) :named ssa_51_conjunct0))
(assert (! (not (= (mod main_~k~1_45 4294967296) 36)) :named ssa_52_conjunct0))
(check-sat)
(get-unsat-core)
